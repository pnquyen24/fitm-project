...
namespace FITM_BE.Util
{
    public static class ServiceExtention
    {
        ...
        private static void InvokeSeeder<TContext>(Action<TContext, IServiceProvider> seeder, TContext context, IServiceProvider scopeServices) where TContext : DbContext
        {
            seeder.Invoke(context, scopeServices);
        }
    }
}
