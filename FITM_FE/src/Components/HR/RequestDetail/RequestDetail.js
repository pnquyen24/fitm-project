          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell
                style={{
                  color:
                    compareData.newStudentID === compareData.oldStudentID
                      ? "black"
                      : "red",
                }}
              >
            ...
            <TableRow>
              ...
              <TableCell>
                {compareData.oldDOB
                  ? new Date(compareData.oldDOB).toLocaleDateString()
                  : ""}
              </TableCell>
              <TableCell
                style={{
                  color:
                    new Date(compareData.oldDOB).toLocaleDateString() ===
                    new Date(compareData.newDOB).toLocaleDateString()
                      ? "black"
                      : "red",
                }}
              >
            ...
            <TableRow>
              ...
              <TableCell
                style={{
                  color:
                    compareData.oldEmail === compareData.newEmail
                      ? "black"
                      : "red",
                }}
              >
            ...
            <TableRow>
              ...
              <TableCell
                style={{
                  color:
                    compareData.oldPhoneNumber === compareData.newPhoneNumber
                      ? "black"
                      : "red",
                }}
              >
            ...
            <TableRow>
              ...
              <TableCell
                style={{
                  color:
                    compareData.oldBankName === compareData.newBankName
                      ? "black"
                      : "red",
                }}
              >
            ...
            <TableRow>
              ...
              <TableCell
                style={{
                  color:
                    compareData.oldBankNumber === compareData.newBankNumber
                      ? "black"
                      : "red",
                }}
              >
            ...
            <TableRow>
              ...
              <TableCell className={`${status[compareData.status]}`}>
